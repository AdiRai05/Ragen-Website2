  ...
  return (
    <main className="pt-40 pb-32">
      ...
      <section className="mt-32">
        <div className="container-width">
          <div className="rounded-[40px] bg-zinc-50 border border-zinc-200 px-10 py-24 text-center">
            <p className="text-sm uppercase tracking-[0.25em] text-zinc-500">
              Stay Updated
            </p>
            <h2 className="mx-auto mt-6 max-w-3xl text-5xl font-semibold tracking-tight">
